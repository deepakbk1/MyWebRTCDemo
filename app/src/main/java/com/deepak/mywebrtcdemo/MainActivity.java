package com.deepak.mywebrtcdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private AppCompatTextView mAudioBitRateText;
    private SwitchCompat mAudioEchoCancelationSwitch;
    private SwitchCompat mAudioAutoGainControlSwitch;
    private SwitchCompat mAudioHighPassFilterSwitch;
    private SwitchCompat mAudioNoiseSupressionSwitch;
    private SwitchCompat mAudioLevelControlSwitch;
    private SwitchCompat mAudioBitRateSwitch;
    private AppCompatTextView mAppLogTextView;
    private AppCompatEditText mRoomIdText;
    private AppCompatToggleButton mMicSwitch;
    private AppCompatToggleButton mSPKSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnectButton =  findViewById(R.id.toggleButton);
        ...
        mStopButton = findViewById(R.id.stoptButton);
        ...
        mCodecSpinner = findViewById(com.deepak.mywebrtcdemo.R.id.codecSpinner);
        ArrayAdapter codecAdapter = ArrayAdapter.createFromResource(this, com.deepak.mywebrtcdemo.R.array.audioCodecs, android.R.layout.simple_spinner_item);
        ...
        mAudioEchoCancelationSwitch = findViewById(R.id.audioEchoCancelationSwitch);
        mAudioAutoGainControlSwitch = findViewById(R.id.audioAutoGainControlSwitch);
        mAudioHighPassFilterSwitch = findViewById(R.id.audioHighPassFilterSwitch);
        mAudioNoiseSupressionSwitch = findViewById(R.id.audioNoiseSupressionSwitch);
        mAudioLevelControlSwitch = findViewById(R.id.audioLevelControlSwitch);
        mAudioBitRateSwitch = findViewById(R.id.audioBitRateSwitch);
        mAudioBitRateText = findViewById(R.id.audioBitRateText);
        mAppLogTextView = findViewById(R.id.AppLog);
        mRoomIdText = findViewById(R.id.roomId);
        mRoomIdText.setText("3333");
        mMicSwitch =  findViewById(R.id.localStreamOff);
        ...
        mSPKSwitch =  findViewById(R.id.remoteStreamOff);
